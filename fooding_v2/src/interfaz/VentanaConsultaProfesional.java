...
public class VentanaConsultaProfesional extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblTitulo.setBounds(320, 10, 310, 30);
        getContentPane().add(jSeparator1);
        jSeparator1.setBounds(20, 50, 800, 10);
        ...
        jSeparator3.setBounds(300, 70, 50, 530);
        ...
        jScrollPane2.setBounds(320, 410, 500, 120);

        lblRespuesta.setText("Mensaje:");
        getContentPane().add(lblRespuesta);
        lblRespuesta.setBounds(330, 390, 100, 16);
